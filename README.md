...
# Sidemark setup
  ...
  1. git clone this repository and execute `npm install`
  2. `git clone https://github.com/team-chiru/sidemark-back.git` and execute `npm install`
  3. in the sidemark-back folder, execute `npm start` in order to start the backend
  4. in this folder execute `npm start` in order to start the dev server
